...
public class LlmHttpRetryTests : IDisposable
{
    ...
    public void Dispose()
    {
        ...
        // GUARDED, exactly as LoopbackServer.Dispose is. Close() walks RemoveListener ->
        // RemovePrefixInternal -> GetEPListener into the PROCESS-GLOBAL HttpEndPointManager map and
        // throws "Address already in use" when that map was corrupted by some other listener's
        // failed Start earlier in the run.
        //
        // Measured unguarded: 3 failures in 6 full-suite runs, EVERY one of them this class's
