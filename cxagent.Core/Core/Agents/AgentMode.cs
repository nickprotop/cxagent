...
/// is replaced. History is NOT rewritten either: an <c>agent</c> call made in fan-out mode stays
...
public enum AgentMode
{
    ...
    /// <summary>
    /// The agent may spawn sub-agents. It is offered <c>agent</c>, and its prompt carries the
