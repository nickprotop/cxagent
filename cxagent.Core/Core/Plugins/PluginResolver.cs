...
/// config never declared: the whole case for the path form is a plugin nobody has configured yet,
/// and a resolver that only understood configured names could not serve it.
/// </summary>
